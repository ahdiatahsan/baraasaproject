    ...
    <x-slot name="toolbar">
        <x-dashboard.toolbar.main>
            ...
            <x-slot name="breadcrumb">
                ...
                <li class="breadcrumb-item text-muted">Ubah Hak Akses</li>
            </x-slot>
        </x-dashboard.toolbar.main>
    </x-slot>
        ...
        <form class="form" action="{{ route('administrator.update', $administrator->id) }}" method="POST"
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title fs-3 fw-bolder">Ubah Hak Akses</div>
                ...
                <div class="card-body">
                    <div class="mb-6">
                        ...
                        <input class="form-control" type="text" name="name" value="{{ $administrator->name }}" readonly>
                    </div>
                    <div class="mb-6">
                    ...
                    <div>
                        ...
                        <select class="form-select" name="role" required>
                            <option value="super_administrator" {{ $administrator->hasRole('super_administrator') ?
                                'selected' :
                                '' }}>Super Administrator</option>
                            <option value="administrator" {{ $administrator->hasRole('administrator') ? 'selected' : ''
                                }}>Administrator</option>
                            <option value="member" {{ $administrator->hasRole('member') ? 'selected' : '' }}>Anggota
                            </option>
                        </select>
                    </div>
                </div>
