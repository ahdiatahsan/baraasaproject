<x-dashboard.layout>
    ...
    <x-slot name="toolbar">
        <x-dashboard.toolbar.main>
            ...
            <x-slot name="breadcrumb">
                ...
                <li class="breadcrumb-item text-muted">Ubah Blog</li>
            </x-slot>
        </x-dashboard.toolbar.main>
    </x-slot>
    ...
    <x-slot name="post">
        ...
        {{-- Start::Content --}}
        <form class="form" action="{{ route('blog.update', $blog->id) }}" method="POST" autocomplete="off"
            enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="card">
                <div class="card-header">
                    <div class="card-title fs-3 fw-bolder">Ubah Blog</div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-7">
                        <label class="form-label">
                            <span class="">Thumbnail Blog</span>
                    ...
                    <div>
                        ...
                        <textarea class="form-control" name="body" id="body" rows="10">{{ $blog->body }}</textarea>
                    </div>
                </div>
