            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a class="btn btn-sm btn-light-primary fw-bolder"
                            href="{{ route('division.show', $divisionGet->id) }}">
                ...
                <div class="card-body">
                    <div class="mb-6">
                        ...
                        <input class="form-control" type="text" name="division_id" value="{{ $divisionGet->id }}"
                            required hidden>
                        <input class="form-control" type="text" name="division_name" value="{{ $divisionGet->name }}"
                            required readonly>
                    </div>
                    <div>
                        <label class="form-label required">Nama Posisi</label>
