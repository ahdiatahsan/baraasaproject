    ...
    <x-slot name="toolbar">
        <x-dashboard.toolbar.main>
            ...
            <x-slot name="breadcrumb">
                ...
                <li class="breadcrumb-item text-muted">Rincian Pengguna Umum</li>
            </x-slot>
        </x-dashboard.toolbar.main>
    </x-slot>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-center flex-column py-5">
                            <div class="symbol symbol-100px symbol-circle border mb-7">
                                ...
                                <img alt="img" src="{{ Storage::url('public/user/' . $general->photo) }}" />
                                @else
                                <img alt="img" src="{{ asset('media/avatars/blank.png') }}" />
                                @endif
                            </div>
                            <span class="fs-3 text-gray-800 fw-bolder mb-3">{{ $general->name }}</span>
                            <div class="mb-9">
                        ...
                        <div id="kt_user_view_details" class="collapse show">
                            <div class="pb-5 fs-6">
                                ...
                                <div class="text-gray-600">{{ $general->email }}</div>

                                <div class="fw-bolder mt-5">Nomor Telepon</div>
                                <div class="text-gray-600">{{ $general->phone_number }}</div>

                                <div class="fw-bolder mt-5">Jenis Kelamin</div>
                                <div class="text-gray-600">
                                    @if ($general->gender == 'L')
                                    Laki-Laki
                                    @elseif ($general->gender == 'P')
                                    Perempuan
                                    @endif
                                </div>
                                ...
                                <div class="text-gray-600">
                                    {{ $general->birthplace . ', ' . $date_of_birth->format('j F Y'); }}
                                </div>

                                <div class="fw-bolder mt-5">Alamat</div>
                                <div class="text-gray-600">{{ $general->address }}</div>

                                @if ($general->division_id != NULL)
                                <div class="fw-bolder mt-5">Divisi</div>
                                <div class="text-gray-600">{{ $general->division->name }}</div>

                                <div class="fw-bolder mt-5">Posisi</div>
                                <div class="text-gray-600">{{ $general->position->name }}</div>
                                @endif
                            </div>
                        </div>
