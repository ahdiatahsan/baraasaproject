<x-dashboard.layout>
    ...
    <x-slot name="toolbar">
        <x-dashboard.toolbar.main>
            ...
            <x-slot name="breadcrumb">
                ...
                <li class="breadcrumb-item text-muted">Ubah Forum</li>
            </x-slot>
        </x-dashboard.toolbar.main>
    </x-slot>
    ...
    <x-slot name="post">
        ...
        {{-- Start::Content --}}
        <form class="form" action="{{ route('thread.update', $thread->id) }}" method="POST" autocomplete="off">
            @csrf
            @method('PATCH')
            <div class="card">
                <div class="card-header">
                    <div class="card-title fs-3 fw-bolder">Ubah Forum</div>
                ...
                <div class="card-body">
                    <div class="mb-6">
                        ...
                        <input class="form-control" type="text" name="title" value="{{ $thread->title }}" required>
                    </div>
                    <div class="mb-7">
                    ...
                    <div>
                        ...
                        <textarea class="form-control" name="body" id="body" rows="10">{{ $thread->body }}</textarea>
                    </div>
                </div>
