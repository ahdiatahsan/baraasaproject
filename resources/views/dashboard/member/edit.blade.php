<x-dashboard.layout>
    ...
    <x-slot name="toolbar">
        <x-dashboard.toolbar.main>
            ...
            <x-slot name="breadcrumb">
                ...
                <li class="breadcrumb-item text-muted">Ubah Anggota</li>
            </x-slot>
        </x-dashboard.toolbar.main>
    </x-slot>
    ...
    <x-slot name="post">
        ...
        {{-- Start::Content --}}
        <form class="form" action="{{ route('member.update', $member->id) }}" method="POST" autocomplete="off"
            enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="card">
                <div class="card-header">
                    <div class="card-title fs-3 fw-bolder">Ubah Anggota</div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-6">
                        ...
                        <select class="form-select" name="division_id" id="select2Division"
                            ...
                            <option value="{{ $member->division_id }}">
                    ...
                    <div class="mb-6">
                        ...
                        <select class="form-select" name="role" required>
                            ...
                            <option value="member" {{ $member->hasRole('member') ? 'selected' : '' }}>Anggota</option>
                            <option value="administrator" {{ $member->hasRole('administrator') ? 'selected' : ''
