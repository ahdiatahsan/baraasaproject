<x-dashboard.layout>
    ...
    <x-slot name="title">Peserta</x-slot>
    {{-- End::Head component --}}
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a class="btn btn-sm btn-light-primary fw-bolder" href="{{ route('participant.index') }}">
                ...
                <div class="card-body">
                    <div class="mb-6">
                        ...
                        <select class="form-select" name="event_id" id="select2Event"
                            data-placeholder="Cari Judul Acara Diikuti" data-allow-clear="true" required>
                        </select>
                    </div>
                    <div class="mb-6">
                    ...
                    <div>
                        ...
                        <select class="form-select" name="data_status" required>
    ...
    <x-slot name="javascript">
        ...
        <script>
            $('#select2Event').select2({
                ...
                ajax: {
                    url: '{{ route("participant.select2-event") }}',
                    dataType: 'json',
                    delay: 250,
        ...
        <script>
            $('#select2User').select2({
                ...
                ajax: {
                    url: '{{ route("participant.select2-user") }}',
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
                        return {
