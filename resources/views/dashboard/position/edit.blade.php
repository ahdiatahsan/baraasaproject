<x-dashboard.layout>
    ...
    <x-slot name="toolbar">
        <x-dashboard.toolbar.main>
            ...
            <x-slot name="breadcrumb">
                ...
                <li class="breadcrumb-item text-muted">Ubah Posisi</li>
            </x-slot>
        </x-dashboard.toolbar.main>
    </x-slot>
    ...
    <x-slot name="post">
        ...
        {{-- Start::Content --}}
        <form class="form" action="{{ route('position.update', $position->id) }}" method="POST" autocomplete="off">
            @csrf
            @method('PATCH')
            <div class="card">
                <div class="card-header">
                    <div class="card-title fs-3 fw-bolder">Ubah Posisi</div>
                ...
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <input class="form-control" type="text" name="name" value="{{ $position->name }}" required>
                    </div>
                </div>
