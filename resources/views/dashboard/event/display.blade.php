    ...
    <x-slot name="toolbar">
        <x-dashboard.toolbar.main>
            ...
            <x-slot name="breadcrumb">
                ...
                <li class="breadcrumb-item text-muted">Tampilan Acara</li>
            </x-slot>
        </x-dashboard.toolbar.main>
    </x-slot>
                            ...
                            <div class="mb-8">
                                <div class="d-flex flex-wrap mb-6">
                                    <div class="me-6 my-1">
                                        ...
                                        <span class="fw-bolder text-gray-500">{{ $date_event }}</span>
                                    </div>

                                    <div class="me-6 my-1">
                                        <span class="svg-icon svg-icon-warning svg-icon-2 me-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none">
                                                <path
                                        ...
                                        <span class="fw-bolder text-gray-500">{{ $event->location }}</span>
                                    </div>
                                ...
                                <a href="#" class="text-dark text-hover-primary fs-2 fw-bolder">{{ $event->title }}</a>

                                <div class="overlay mt-8">
                                    <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-350px"
                                        style="background-image:url('https://images8.alphacoders.com/548/548694.jpg')">
                                    </div>
                                </div>
                            </div>
