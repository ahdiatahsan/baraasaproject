<div id="kt_aside" class="aside" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '225px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle" data-kt-sticky="true" data-kt-sticky-name="aside-sticky" data-kt-sticky-offset="{default: false, lg: '1px'}" data-kt-sticky-width="{lg: '225px'}" data-kt-sticky-left="auto" data-kt-sticky-top="94px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
    <div class="hover-scroll-y my-5 my-lg-5 w-100 ps-4 ps-lg-0 pe-4 me-1" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_header" data-kt-scroll-wrappers="#kt_aside" data-kt-scroll-offset="5px">
        ...
        <div class="menu menu-column menu-active-bg menu-hover-bg menu-title-gray-700 fs-6 menu-rounded w-100" id="#kt_aside_menu" data-kt-menu="true">
            ...
            {{-- Start::Forum --}}
            <x-administrator.aside.single_menu linkClass="{{ $threadMenu }}" title="Forum" url="{{ route('thread.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Komentar --}}
            <x-administrator.aside.single_menu linkClass="{{ $commentMenu }}" title="Komentar" url="{{ route('comment.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M21.7189 13.9C17.6189 9.8 11.4189 8.79999 6.21895 11.2L7.31895 12.9C11.719 11 16.919 12 20.319 15.4C20.519 15.6 20.819 15.7 21.019 15.7C21.219 15.7 21.5189 15.6 21.7189 15.4C22.1189 14.9 22.1189 14.2 21.7189 13.9Z" fill="black" />
                        <path opacity="0.3" d="M10.119 17.1L3.61896 7L2.01895 14.3C1.91895 14.8 2.21895 15.4 2.81895 15.5L10.119 17.1Z" fill="black" />
                    </svg>
                </x-slot>
            </x-administrator.aside.single_menu>
            {{-- End::Komentar --}}
            ...
            {{-- Start::Jurnal --}}
            <x-administrator.aside.single_menu linkClass="{{ $researchMenu }}" title="Jurnal" url="{{ route('research.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Acara --}}
            <x-administrator.aside.single_menu linkClass="{{ $eventMenu }}" title="Acara" url="{{ route('event.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Peserta --}}
            <x-administrator.aside.single_menu linkClass="{{ $participantMenu }}" title="Peserta" url="{{ route('participant.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Sertifikat --}}
            <x-administrator.aside.single_menu linkClass="{{ $certificateMenu }}" title="Sertifikat" url="{{ route('certificate.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Perekrutan --}}
            <x-administrator.aside.single_menu linkClass="{{ $recruitmentMenu }}" title="Perekrutan" url="{{ route('recruitment.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Anggota --}}
            <x-administrator.aside.single_menu linkClass="{{ $memberMenu }}" title="Anggota" url="{{ route('member.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Divisi --}}
            <x-administrator.aside.single_menu linkClass="{{ $divisionMenu }}" title="Divisi" url="{{ route('division.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path opacity="0.3" d="M11 20.8129C11 21.4129 10.5 21.9129 9.89999 21.8129C5.49999 21.2129 2 17.5128 2 12.9128C2 8.31283 5.39999 4.51281 9.89999 4.01281C10.5 3.91281 11 4.41281 11 5.01281V20.8129Z" fill="black" />
                        <path d="M13 18.8129C13 19.4129 13.5 19.9129 14.1 19.8129C18.5 19.2129 22 15.5128 22 10.9128C22 6.31283 18.6 2.51281 14.1 2.01281C13.5 1.91281 13 2.41281 13 3.01281V18.8129Z" fill="black" />
                    </svg>
                </x-slot>
            </x-administrator.aside.single_menu>
            {{-- End::Divisi --}}
            ...
            {{-- Start::Posisi --}}
            <x-administrator.aside.single_menu linkClass="{{ $positionMenu }}" title="Posisi" url="{{ route('position.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Umum --}}
            <x-administrator.aside.single_menu linkClass="{{ $generalMenu }}" title="Umum" url="{{ route('general.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Aplikasi --}}
            <x-administrator.aside.single_menu linkClass="{{ $settingMenu }}" title="Aplikasi" url="{{ route('setting.edit', 1) }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Notifikasi --}}
            {{-- <x-administrator.aside.single_menu linkClass="{{ $notificationMenu }}" title="Notifikasi" url="{{ route('notification.index') }}">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
