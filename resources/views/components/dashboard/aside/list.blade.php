<div id="kt_aside" class="aside" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '225px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle" data-kt-sticky="true" data-kt-sticky-name="aside-sticky" data-kt-sticky-offset="{default: false, lg: '1px'}" data-kt-sticky-width="{lg: '225px'}" data-kt-sticky-left="auto" data-kt-sticky-top="94px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
    <div class="hover-scroll-y my-5 my-lg-5 w-100 ps-4 ps-lg-0 pe-4 me-1" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_header" data-kt-scroll-wrappers="#kt_aside" data-kt-scroll-offset="5px">
        ...
        <div class="menu menu-column menu-active-bg menu-hover-bg menu-title-gray-700 fs-6 menu-rounded w-100" id="#kt_aside_menu" data-kt-menu="true">
            ...
            {{-- Start::Forum --}}
            <x-dashboard.aside.single_menu linkClass="{{ $threadMenu }}" title="Forum" url="{{ route('thread.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Komentar --}}
            <x-dashboard.aside.single_menu linkClass="{{ $commentMenu }}" title="Komentar" url="{{ route('comment.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Jurnal --}}
            <x-dashboard.aside.single_menu linkClass="{{ $researchMenu }}" title="Jurnal" url="{{ route('research.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Peserta --}}
            <x-dashboard.aside.single_menu linkClass="{{ $participantMenu }}" title="Peserta" url="{{ route('participant.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Sertifikat --}}
            <x-dashboard.aside.single_menu linkClass="{{ $certificateMenu }}" title="Sertifikat" url="{{ route('certificate.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Perekrutan --}}
            <x-dashboard.aside.single_menu linkClass="{{ $recruitmentMenu }}" title="Perekrutan" url="{{ route('recruitment.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Anggota --}}
            <x-dashboard.aside.single_menu linkClass="{{ $memberMenu }}" title="Anggota" url="{{ route('member.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Divisi --}}
            <x-dashboard.aside.single_menu linkClass="{{ $divisionMenu }}" title="Divisi" url="{{ route('division.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Posisi --}}
            <x-dashboard.aside.single_menu linkClass="{{ $positionMenu }}" title="Posisi" url="{{ route('position.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Umum --}}
            <x-dashboard.aside.single_menu linkClass="{{ $generalMenu }}" title="Umum" url="{{ route('general.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Administrator --}}
            <x-dashboard.aside.single_menu linkClass="{{ $administratorMenu }}" title="Administrator" url="{{ route('administrator.index') }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Aplikasi --}}
            <x-dashboard.aside.single_menu linkClass="{{ $settingMenu }}" title="Aplikasi" url="{{ route('setting.edit', 1) }}">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {{-- Start::Notifikasi --}}
            {{-- <x-dashboard.aside.single_menu linkClass="{{ $notificationMenu }}" title="Notifikasi" url="{{ route('notification.index') }}">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
